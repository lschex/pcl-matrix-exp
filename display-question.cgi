...
#    print "cond: $cond<br>\n";
   ...
   if ($cond  =~ m/a$/) {
    $phrase = $anim1 . " " . $prep . " the " . $adj . " " . "[inaudible]"; #underlyingly $inan1
    ...
    $phrase = $anim1 . " " . $prep . " the " . $adj . " " . "[inaudible]"; #underlyingly $inan2
...
print "<input type=\"button\" onclick=\"play()\" class=\"myButton\" alt=\"Click on the $phrase.\">";
print "<audio id=\"audio-button\" src=\"audio/$audiofile.mp3\"\></audio>";
...
print "</div>";
 ...
 <script>
 function checkform1() {
    var x = document.getElementById(\"audio-button\");
    if (x.ended) {
