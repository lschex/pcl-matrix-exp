...
print "<p>As you navigate through the study, you will go through a series of 36 scenes. Each scene contains five pictures arranged in a circle. In the middle of the circle is an audio control button. Press play on the audio control button to hear the instructions. The instructions will tell you which picture to choose. Once you have clicked on the picture, you will be taken to the next question.</p>\n";
